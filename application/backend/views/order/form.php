...
$inputGroupACP  = HelperBackend::cmsSelectboxNumeric("form[group_acp]", 'form-control custom-select', $groupACPValue, @$data['group_acp']);
...
$cancelLink     = URL::createLink('backend', 'group', 'index');
