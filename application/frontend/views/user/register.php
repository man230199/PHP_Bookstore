<?php
    ...
    $inputUserName      = HelperBackend::createInput('text', "form[username]", @$data['username']);
    $inputEmail         = HelperBackend::createInput('text', "form[email]", @$data['email']);
    $inputFullName     = HelperBackend::createInput('text', "form[fullname]", @$data['fullname']);
    $inputPassword     = HelperBackend::createInput('password', "form[password]", @$data['password']);
