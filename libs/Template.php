...
class Template{
	...
	public function load(){
		...
		if(file_exists($pathFileConfig)){
			...
			$view->_pluginCss 	= $view->createLink($this->_folderTemplate . $arrCongif['dirPluginsCss'], $arrCongif['filePluginCss'], 'css');
			$view->_pluginJs 	= $view->createLink($this->_folderTemplate . $arrCongif['dirPluginsJs'], $arrCongif['filePluginJs'], 'js');
